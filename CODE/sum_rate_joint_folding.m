function [sum_r_temp] = sum_rate_joint_folding(psi1,psi2,psi3,x_UPA,y_UPA,z_UPA,Nh,Nv,K,L,phi1,phi2,phi3,theta1,theta2,theta3,alpha1,alpha2,alpha3,lambda,P,Ant_type,ka)
d=lambda/2;
